import { clampMax, clampMin, clampRange } from '@utils/clamp'
...
export function interpolate(
  ...
  if (clamp === 'start') {
    return clampMin(interpolatedValue, outStart)
  }

  if (clamp === 'end') {
    return clampMax(interpolatedValue, outEnd)
  }
